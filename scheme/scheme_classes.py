...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        "*** YOUR CODE HERE ***"
        instance=Frame(self)
        formaltemp,valtemp=formals,vals
        while(formaltemp!=nil and valtemp!=nil):
            instance.bindings[formaltemp.first]=valtemp.first
            formaltemp=formaltemp.rest
            valtemp=valtemp.rest
        return instance
        # END PROBLEM 8
